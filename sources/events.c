...
void	zoom_out(t_data *data, double zoom_factor, double center_re, double center_im)
{
...
void	zoom_in(t_data *data, double zoom_factor, double center_re, double center_im)
{
	data->zoom *= zoom_factor;
	data->min_re = center_re - (center_re - data->min_re) / zoom_factor;
	data->max_re = center_re + (data->max_re - center_re) / zoom_factor;
